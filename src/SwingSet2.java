...
//		statusField.setEditable(false);
		...
		JLabel hintLabel = N9ComponentFactory.createLabel_style1("������ʾ");
...
//				tb.setText(null);
	...
	public void showSwingSet2() {
		if(!isApplet() && getFrame() != null) {
			...
			JFrame f = getFrame();
			f.setTitle(getString("Frame.title")+" - BeautyEye L&F(QȺ:259448663)");
	...
	public static JFrame createFrame(GraphicsConfiguration gc) {
		...
		//��Jack Jiang��2012-09-22���ϣ���ֹ��JToolBar�Ĵ�С��Ӱ��JFrame��prefereSizeʹ��û������С
