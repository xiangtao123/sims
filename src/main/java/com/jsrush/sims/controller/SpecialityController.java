...
public class SpecialityController {
	...
	public String index(Model model) {
		...
		List<Map<Long, String>> deptList = deptService.findListByEcId(currentUserEcId);
		model.addAttribute("deptList", deptList);
		return "sims/speciality_index";
	}
	
	@RequestMapping(value="/list")
	@ResponseBody
	public Map<String,Object> list(Speciality condtion,
		...
		try {
			...
			return specialityService.findPageList(condtion, pageNo, pageSize);
		} catch (Exception e) {
			logger.error("专业-查询列表失败", e);
	...
	@ResponseBody
	public int saveOrUpdate(Speciality dto) {
		try {
			Long currentUserEcId = shiroManager.getCurrentUserEcId();
